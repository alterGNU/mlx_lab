...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   t_hit_fun_drawlines.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lagrondi <lagrondi.student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/04 12:13:33 by lagrondi          #+#    #+#             */
/*   Updated: 2026/01/25 09:26:46 by lagrondi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_hline(t_ima *img, int x, t_fpos pos, int color)
{
	while (x <= pos.x)
	{
		if (x >= 0 && x < img->dim.x && pos.y >= 0 && pos.y < img->dim.y)
 ...
 */
void	draw_vlines_generic(t_ima *img, int x, t_ipos y, int color)
{
	if (x < 0 || x >= img->dim.x)
		return ;
	while (y.x <= y.y)
