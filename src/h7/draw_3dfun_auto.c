...
////img->draw_vtext(t_img *src, t_img *dst, t_ipos img_pix, t_ipos y_inter, float ty_step)
//static void fun(t_text *src, t_img *dst, t_ipos img_pix, t_ipos y_inter, float ty_step)
//{
//	int		index_text;
//
