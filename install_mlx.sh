...
install_cmd()
{
    ...
    if cmd_exist "${cmd_name}";then
        ...
        print_in_log_file sudo apt-get install ${pck_name}
        sudo apt-get install -y ${pck_name} 1>> ${log_file}\
...
install_pck()
{
    ...
    if pck_installed "${1}";then
        ...
        print_in_log_file sudo apt-get install ${pck_name}
        sudo apt-get install -y ${1} 1>> ${log_file}\
            && local suf="${V} (successfully installed)${E} ✅" \
            || local suf="${R} Failed to install${E} ❌ "
        print_in_log_file "\n"
    fi
...
sudo apt-get update && pnt ${B}"${SEP}${E}" "$((LEN - 2))" && echo "✅"
title_2 "2.2| Upgrade:" && pnt "${B}${SEP}${E}" $((LEN - 13)) && echo
sudo apt-get upgrade && pnt ${B}"${SEP}${E}" "$((LEN - 2))" && echo "✅"
title_2 "2.3| Autoremove:" && pnt "${B}${SEP}${E}" $((LEN - 16)) && echo
sudo apt-get autoremove && pnt "${B}${SEP}${E}" "$((LEN - 2))" && echo "✅"
